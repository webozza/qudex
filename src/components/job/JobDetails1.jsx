...
const JobDetails1 = () => {
  ...
  return (
    <>
            ...
            <div className="col-xxl-9 col-xl-9 col-lg-8 col-md-8">
              <div className="job__detail-wrapper">
                ...
                <div className="job__apply btn_wrapper">
                  <button onClick={jobApply} className="wc-btn-primary btn-hover btn-item">
      ...
      <div>
        <JobDetailsModal1 modal1={modal1} setModal1={setModal1} setModal2={setModal2} />
        <JobDetailsModal2 setModal1={setModal1} modal2={modal2} setModal2={setModal2} />
      </div>
    </>
  );
};
