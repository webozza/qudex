                  ...
                  <SwiperSlide>
                    <div className="testimonial__slide-4">
                      ...
                      <div className="testimonial__info-4">
                        ...
                        <p>Our philosophy is built on people who are addicted on creating, learning, and growing together, which allows us to discover better others miss.</p>
                  ...
                  <SwiperSlide>
                    <div className="testimonial__slide-4">
                      ...
                      <div className="testimonial__info-4">
                        ...
                        <p>I am very glod happy with this theme, the website loads much faster than any other theme I have used so far clean code and responsive layout.</p>
                  ...
                  <SwiperSlide>
                    <div className="testimonial__slide-4">
                      ...
                      <div className="testimonial__info-4">
                        ...
                        <p>In the next time I hire qudex as they helping innovators and brands through cultural insight, strategiccal vision, and innovation and look too beyond.</p>
