            ...
            <div className="row">
              <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
                ...
                <div className="workflow__slide-6">
                  ...
                  <p>QUDE™ lets you offset your carbon and nature based offsets</p>
                </div>
              </div>
              ...
              <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
                ...
                <div className="workflow__slide-6">
                  <h6 className="workflow__title-6">Automatic offset systems</h6>
              ...
              <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
                ...
                <div className="workflow__slide-6">
                  <h6 className="workflow__title-6">Add Legacy to your business</h6>
                  <p>Take your business to a level of being remembered and save the planet.</p>
                </div>
              </div>
            </div>
          </div>
