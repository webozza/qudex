          ...
          <div className="sec-title-wrapper">
            <div className="row">
              <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                ...
                <h3 className="sec-title title-anim">Our Approach</h3>
              </div>
              <div className="col-xxl-7 col-xl-7 col-lg-7 col-md-7">
                <div className="story__text">
                  <p>QUDEX provides businesses the means to actively contribute to the restoration and preservation of our natural environment. By sponsoring QUDEs, which represent quantifiable, verifiable environmental data on the platform, companies can directly aid in the revitalization of degraded landscapes and habitats. This groundbreaking approach to corporate responsibility allows businesses to make a tangible and lasting impact, benefiting not just the environment, but also their reputation and relationships with customers and investors.</p>
